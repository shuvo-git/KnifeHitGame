...
var UIBoard = UISprite.extend({
    ...
    setPhysicsWorld : function (world){
     ...
     getBoard : function(level){
        ...
        //Target body
        this.mBoard  = new CircleBody(this.mWorld, kTargetRadius, Box2D.Dynamics.b2Body.b2_dynamicBody, KTargetDensity, KTargetRestitution, KTargetFriction, cc.p(this.getPositionX(), this.getPositionY()), KeyForTargetText, this, kTargetCategory, kTargetMask);
